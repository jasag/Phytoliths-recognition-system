...
\begin{enumerate}[1.]
  ...
  \item Entrenar\footnote{Nos refererimos por entrenar, en este ámbito, a enviar al clasificador las distintas imágenes con la clase a la que pertenecen (fitolito de tipo 1, fitolito de tipos 2, etcétera).} el clasificador.
\end{enumerate}
