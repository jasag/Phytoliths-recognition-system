...
\tablaSmallSinColores{Caso de uso 1: Entrenar detector}{p{3cm} p{.75cm} p{9.5cm}}{tablaUC1}{
 ...
 }
 {
  ...
  \\\cline{2-3}
                                         & 2    & Se carga el conjunto de imágenes.
  \\\cline{2-3}
                                         & 3    & Se calculan los \textit{clusters}.
    \\\cline{2-3}
                                         & 4    & Se halla el conjunto de entrenamiento.                                           	\\\cline{2-3}
                                         & 5    & Se comienza el entrenamiento. 
                                         \\\hline
  Postcondiciones                        & \multicolumn{2}{p{10.25cm}}{Se el clasificador y el \textit{cluster}.} \\\hline
