...
\begin{figure}[h]
\centering
\includegraphics[width=0.80\textwidth]{v010}
...
Una vez cargada la imagen en el etiquetador, y comprendido el uso de los botones de selección de tipo de fitolito, podemos comenzar a  etiquetar fitolitos. Para etiquetar, basta con clicar en la imagen, definiendo una esquina del rectángulo, mover el ratón hacía donde deseemos y volver a clicar, definiendo la otra esquina de este. Para, así, definir una etiqueta como la que se puede ver en la figura \ref{fig:E.4.6}.
...
\caption[Notificación en la carga incorrecta]{Notificación en la carga incorrecta de un fichero que no sea una imagen}
\label{fig:E.4.8.2}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=1\textwidth]{ilparameters}
...
\begin{figure}
\centering
\includegraphics[width=1\textwidth]{reconocimiento}
